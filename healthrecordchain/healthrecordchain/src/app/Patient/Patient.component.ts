...
export class PatientComponent implements OnInit {
  ...
  authorizedDoctors = new FormControl('', Validators.required);
  ...
  constructor(public servicePatient: PatientService, fb: FormBuilder) {
    this.myForm = fb.group({
      ...
      authorizedDoctors: this.authorizedDoctors,
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.healthrecordchain.Patient',
      'patientType': this.patientType.value,
      'authorizedDoctors': this.authorizedDoctors.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.patientType) {
        formObject.patientType = result.patientType;
      } else {
        formObject.patientType = null;
      }

      if (result.authorizedDoctors) {
        formObject.authorizedDoctors = result.authorizedDoctors;
      } else {
        formObject.authorizedDoctors = null;
      }
